---
title: "Importance of Leadership"
description: "This one has been a tricky one to write, as I started it over a year ago and a bunch of things had happened since, but it all feeds into my thoughts on what I consider to be good leadership. When I first started out, I put very little thought into the actual leadership abilities of those I worked with or for. When I landed my first job, like everyone, I was primarily focused on establishing myself, building my skillset and what projects I got to work on, as well the after work socialising. You kind of implicitly trust people in leadership roles know what they're doing, but with no real-world experience of what good leadership entails."
pubDate: "6 Feb 2026"
...
Bosses care about optics, short-term results, and not exactly how they are achieved, nor the last impact to the team that the achieving of these results cost. They tend to rule by fear, and generally foster a blame culture. They want the plaudits when there are successes, but none of the failures or problems. As a result, if you notice a high turnover of staff, you'd probably be best joining them.
